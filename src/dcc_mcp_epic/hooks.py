...
HOOK_OPERATION_REQUIRED_FIELDS = {
    ...
    "fab.catalog_free.request": ["free_only", "limit"],
    "fab.asset_detail.request": ["asset_id"],
    "fab.library.request": [],
    "fab.library_sources.request": [],
    "fab.library_sync.request": ["launcher_pid", "allowed_root"],
    "fab.free_assets_sync.request": ["assets", "allowed_root", "mode", "free_only"],
    "fab.download.request": ["asset_id", "project_path", "format"],
    "fab.download_batch.request": ["assets", "project_path"],
    "fab.add_to_library.request": ["asset_id", "expected_price", "free_listing"],
    "fab.add_to_library_batch.request": ["assets", "expected_price", "free_listing"],
